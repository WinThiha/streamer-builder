# connector-persistence Specification

## Purpose

PostgreSQL-backed connector configuration with Drizzle schema, migrations, seed, and repository access for resolve and admin APIs.
## Requirements
