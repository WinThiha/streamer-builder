# catalog-detail-search Specification

## Purpose

Web search and title detail pages (movie and TV with season/episode selection) that produce `MediaRef` values for playback.
## Requirements
